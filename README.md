...
```typescript
// Ubicación: src/components/organism/Sidebars/ProccessLayout.tsx (o tu ruta del layout)
const sidebarComponents: Record<string, React.ReactNode> = {
  aoi: <AoiSidebar />,
  "pick-and-place": <PickandPlaceSidebar />,
  "tu-nuevo-proceso": <TuNuevoSidebar />, // 👈 Agrega tu nuevo proceso aquí
};
```
